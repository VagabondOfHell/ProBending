...
const unsigned short ProjectileManager::BASE_NUM_WATER_PROJECTILES = 3;
const unsigned short ProjectileManager::BASE_NUM_FIRE_PROJECTILES = 3;
const unsigned short ProjectileManager::BASE_NUM_EARTH_PROJECTILES = 3;
