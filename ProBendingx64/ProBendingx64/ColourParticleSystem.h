...
class ColourParticleSystem :
	public ParticleSystemBase
{
protected:
	enum DevicePointers{ValidBitmap, Lifetimes, DevicePointerCount};
	enum GraphicsResourcePointers{Positions, Colour, GraphicsResourcePointerCount};
	...
	float* lifetimes;
	 ...
	 physx::PxVec4 startColor;
	 physx::PxVec4 endColor;
	 physx::PxVec4 fadeRate;
	...
	Ogre::HardwareVertexBufferSharedPtr mVertexBufferColour;
...
public:
	ColourParticleSystem(AbstractParticleEmitter* _emitter, size_t _maximumParticles, float _initialLifetime,
		physx::PxVec4 startColor, physx::PxVec4 endColor, physx::PxVec4 fadeRate,
		ParticleSystemParams& paramsStruct = ParticleSystemParams(), bool _ownEmitter = true);

	virtual ~ColourParticleSystem(void);
